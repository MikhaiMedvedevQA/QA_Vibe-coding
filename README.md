...
Михаил — QA-инженер ручного тестирования B2B/B2C-продуктов страховой компании. Финальный проект практического курса по вайб-кодингу от [Zerocoder](https://zerocoder.ru/#courses).
